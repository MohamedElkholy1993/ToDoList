...
- (void)readDataFromPlist{
    ...
    for (NSDictionary *item in array)
    {
        ...
        if ([[item objectForKey:@"status"] isEqualToString:@"InProgress"] && [[item objectForKey:@"priority"] isEqualToString:@"High"])
        {
    ...
    for (NSDictionary *item in array)
    {
        ...
        if ([[item objectForKey:@"status"] isEqualToString:@"InProgress"] && [[item objectForKey:@"priority"] isEqualToString:@"Medium"])
        {
            [_tasks addObject:[Task initWithDic:item]];
        }
    ...
    for (NSDictionary *item in array)
    {
        ...
        if ([[item objectForKey:@"status"] isEqualToString:@"InProgress"] && [[item objectForKey:@"priority"] isEqualToString:@"Low"])
        {
            [_tasks addObject:[Task initWithDic:item]];
        }
